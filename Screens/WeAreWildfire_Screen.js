...
export default class WeAreWildfire_Screen extends Component{
  constructor(){
    super()
      this.state = {
        currentLevel:1,
        ...
        lightconeName: 'We Are Wildfire',

        dropArray: [0,0,0],
        dropsNames : ['Ancient Part', 'Ancient Spindle', 'Ancient Engine'],

        calyxArray: [0,0,0],
        calyxNames : ['Endurance of Bronze', 'Oath of Steel', 'Safeguard of Amber']
