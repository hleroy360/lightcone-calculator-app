...
export default class TheSeriousnessOfBreakfast_Screen extends Component{
  constructor(){
    super()
      this.state = {
        currentLevel:1,
        ...
        lightconeName: 'The Seriousness of Breakfast',

        dropArray: [0,0,0],
        dropsNames : ['Extinguished Core', 'Glimmering Core', 'Squirming Core'],

        calyxArray: [0,0,0],
        calyxNames : ['Key of Inspiration', 'Key of Knowledge', 'Key of Wisdom']
